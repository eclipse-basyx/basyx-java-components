...
package basyx.components.updater.transformer.cameljsonata.configuration.factory;

import basyx.components.updater.core.configuration.factory.DataTransformerConfigurationFactory;
import basyx.components.updater.transformer.cameljsonata.configuration.JsonataTransformerConfiguration;
