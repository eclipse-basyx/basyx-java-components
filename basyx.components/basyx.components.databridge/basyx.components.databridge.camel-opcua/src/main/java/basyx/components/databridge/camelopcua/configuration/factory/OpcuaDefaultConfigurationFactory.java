...
package basyx.components.databridge.camelopcua.configuration.factory;

import basyx.components.databridge.camelopcua.configuration.OpcuaConsumerConfiguration;
