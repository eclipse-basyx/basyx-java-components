...
package basyx.components.databridge.camelkafka.configuration.factory;

import basyx.components.databridge.camelkafka.configuration.KafkaConsumerConfiguration;
