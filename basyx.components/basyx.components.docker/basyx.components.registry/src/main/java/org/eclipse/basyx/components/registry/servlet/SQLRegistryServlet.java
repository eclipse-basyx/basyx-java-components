 ...
 */
public class SQLRegistryServlet extends VABHTTPInterface<RegistryModelProvider> {
	...
	public SQLRegistryServlet() {
		super(new RegistryModelProvider(new SQLRegistry()));
	}
	...
	public SQLRegistryServlet(BaSyxSQLConfiguration sqlConfig) {
		super(new RegistryModelProvider(new SQLRegistry(sqlConfig)));
	}
	...
	public SQLRegistryServlet(BaSyxSQLConfiguration sqlConfig, BaSyxMqttConfiguration mqttConfig) {
		super(new RegistryModelProvider(new MqttRegistryFactory().create(new SQLRegistry(sqlConfig), mqttConfig)));
	}
}
